...
// UI
export const EMAIL = 'contact@barkprotocol.net';
...
// Solana
export const TOKEN_PATH = 'https://raw.githubusercontent.com/bark-community/bark-wallet-metadata/main/';
export const MEMO_PROGRAM_ID = new PublicKey('MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr');
export const IS_DEV = process.env.NEXT_PUBLIC_IS_DEV === 'true';
export const SPL_TOKEN = new PublicKey(
  IS_DEV ? 'BARKanRruQPJbJoBEJATQg5hrmaQ1NNNFdTwdgGgRaBd' : 'BARKZV4nBBm21Ha47RAW3nYzSU9FpnMNSHxRp7P4FGJ3'
);
